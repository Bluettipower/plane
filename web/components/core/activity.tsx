    ...
    >
      {activity?.issue_detail ? (
        <a
          ...
          className="items-center inline gap-1 font-medium text-custom-text-100 hover:underline"
        >
...
const activityDetails: {
        ...
        return (
          <span className="overflow-hidden">
            ...
            <span className="inline-flex items-center gap-2 rounded-full border border-custom-border-300 px-2 py-0.5 text-xs">
              ...
              <span className="flex-shrink font-medium break-all text-custom-text-100 line-clamp-1">
                {activity.new_value}
              </span>
            </span>
            {showIssue && (
  ...
  state: {
    message: (activity, showIssue) => (
      <>
        set the state to <span className="font-medium break-all text-custom-text-100">{activity.new_value}</span>
        {showIssue && (
          <>
            {" "}
            for <IssueLink activity={activity} />
