        ...
        onGenerateDragPreview: ({ nativeSetDragImage }) => {
          ...
          setCustomNativeDragPreview({
            ...
            render: ({ container }) => {
              ...
              root.render(
                <div className="flex items-center p-1 pr-2 text-sm rounded bg-custom-background-100">
                  <div className="flex grid items-center flex-shrink-0 w-5 h-7 place-items-center">
            ...
            >
              ...
              <Tooltip tooltipContent={`${project.name}`} position="right" disabled={!isCollapsed} isMobile={isMobile}>
                ...
                >
                  ...
                  >
                    <div className="grid flex-shrink-0 w-5 h-7 place-items-center">
