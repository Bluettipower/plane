...
const InviteMemberInput: React.FC<InviteMemberFormProps> = (props) => {
  ...
  return (
    <div>
      <div className="relative grid grid-cols-10 gap-4 group">
          ...
          <Controller
            ...
            render={({ field: { value, onChange, ref } }) => (
              <Input
                ...
                className="w-full text-xs border-onboarding-border-100 placeholder:text-onboarding-text-400 sm:text-sm"
                autoComplete="off"
              />
            )}
          />
            ...
            render={({ field: { value, onChange } }) => (
              ...
              >
                ...
                >
                  <Listbox.Options
                    ref={dropdownRef}
                    className="fixed z-10 w-48 mt-1 overflow-y-auto border rounded-md shadow-sm h-fit sm:w-60 border-onboarding-border-100 bg-onboarding-background-200 focus:outline-none"
                  >
        ...
        {fields.length > 1 && (
          <button
            type="button"
            className="absolute right-0 self-center hidden rounded place-items-center group-hover:grid"
...
export const InviteMembers: React.FC<Props> = (props) => {
  ...
  return (
    <div className="flex w-full h-full">
      <div className="w-full h-full px-6 py-10 overflow-auto sm:px-7 sm:py-14 md:px-14 lg:px-28">
        ...
        <div className="flex flex-col items-center justify-center w-full p-8 mx-auto mt-6 md:w-4/5">
          <div className="w-4/5 py-4 mx-auto space-y-1 text-center">
          ...
          >
            <div className="w-full py-4 text-sm">
              <div className="relative grid grid-cols-10 gap-4 py-2 mx-8 group">
                <div className="col-span-6 px-1 text-sm font-medium text-onboarding-text-200">Email</div>
                <div className="col-span-4 px-1 text-sm font-medium text-onboarding-text-200">Role</div>
              </div>
            ...
            <div className="flex flex-col items-center justify-center w-full gap-4 px-8 mx-auto sm:px-2 max-w-96">
              <Button
                variant="primary"
                type="submit"
                size="lg"
              ...
              <Button variant="link-primary" size="lg" className="w-full" onClick={nextStep}>
                I’ll do it later
              </Button>
            </div>
          </form>
      ...
      <div className="relative hidden w-2/5 h-screen px-6 py-10 overflow-hidden lg:block sm:px-7 sm:py-14 md:px-14 lg:px-28">
        <SwitchAccountDropdown />
        <div className="absolute inset-0 z-0">
          <Image
            src={resolvedTheme === "dark" ? InviteMembersDark : InviteMembersLight}
            className="object-cover w-auto h-screen float-end"
            alt="Profile setup"
          />
        </div>
      </div>
