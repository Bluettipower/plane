      ...
      {!!invitedWorkspaces && (
        <>
          <Button
            ...
            size="lg"
            className="flex items-center w-full gap-2 text-base bg-custom-background-90"
            onClick={handleCurrentViewChange}
          >
            I want to join invited workspaces{" "}
            <span className="flex items-center justify-center w-4 h-4 text-xs font-medium text-white rounded-sm bg-custom-primary-200">
              {invitedWorkspaces}
            </span>
          </Button>
          <div className="flex items-center mx-auto mt-4 sm:w-96">
            <hr className="w-full border-onboarding-border-100" />
            <p className="flex-shrink-0 mx-3 text-sm text-center text-onboarding-text-400">or</p>
            <hr className="w-full border-onboarding-border-100" />
          </div>
        </>
      )}
      <div className="py-4 mx-auto space-y-1 text-center">
